...
-   configurar encoding por default en UTF-8 (como se muestra en la [instalación de herramientas)](preparacion-de-un-entorno-de-desarrollo-java.html). Aplicar cambios
