...
- **Modelo de Cascada**: nunca existió, fue una maliciosa interpretación del [paper de Winston Royce: "Managing the development of large software systems"](http://www-scf.usc.edu/~csci201/lectures/Lecture11/royce1970.pdf). Les recomendamos ver [este interesante video al respecto](https://www.youtube.com/watch?v=NP9AIUT9nos), para entender lo inapropiado y excesivamente optimista que es aplicar esta metodología en un proceso de desarrollo actual.
- **Espiral de Boehm**: originado en el [paper de Barry Boehm: "A Spiral Model of Software Development and Enhancement"](https://web.archive.org/web/20190608071743/https://csse.usc.edu/TECHRPTS/1988/usccse88-500/usccse88-500.pdf), surge como primer contracara del modelo de cascada. Sigue un modelo de planificación de objetivos, identificación de riesgos y desarrollo y verificación del producto en *n iteraciones*,
